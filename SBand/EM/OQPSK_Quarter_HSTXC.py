...
class OQPSK_Quarter_HSTXC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_win = qtgui.RangeWidget(self._gain_range, self.set_gain, "Manual Gain (dB)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._frequency_win = qtgui.RangeWidget(self._frequency_range, self.set_frequency, "Receive Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        for c in range(0, 1):
            self.settings_grid_layout_1.setColumnStretch(c, 1)
        self._loop_bw_range = qtgui.Range(0.0005, 1, 0.0005, 0.01, 200)
        ...
        self._center_freq_range = qtgui.Range(-50000, 50000, 50, 0, 200)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/albertasat/ex3_sdr/ex3_sdr/SBand/EM/test.txt', False)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.frequency, (self.samp_rate * 2))
